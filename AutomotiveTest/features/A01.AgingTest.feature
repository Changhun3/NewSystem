...
Feature: Avtovaz_AgingTest
  ...
  Scenario: AgingTest 시작하기
    ...
    Radio CH을 1 > 2 > 3 > 1 동작을 20초 간격으로 10회 수행한다.(약 600초)
    ############# ch.1 선택 > 20초 > ch.2선택 > 20초 > ch.3선택 > 20초. 해당 cycle을 10회 반복 필요.(총 약 600초)
    Yendex Music을 play하고 40초 간격으로 20번 수행한다.(약 800초)
